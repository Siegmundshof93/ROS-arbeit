...
acx = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
acx["Accelerometer X axis"] = ""
acx.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
acx = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
acx["Accelerometer X axis"] = accx
acx.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)

acy = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
acy["Accelerometer Y axis"] = ""
acy.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
acy = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
acy["Accelerometer Y axis"] = accy
acy.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)

acz = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
acz["Accelerometer Z axis"] = ""
acz.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
acz = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
...
gyrx = ((gyrx * 2000 / 32768) / 26) - 5.3
gyry = ((gyry * 2000 / 32768) / 10 )  - 3.5
gyrz = ((gyrz * 2000 / 32768) / 7 ) + 1

gyx = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
gyx["Gyro X axis"] = ""
gyx.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
gyx = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
gyx["Gyro X axis"] = gyrx
gyx.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)

gyy = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
gyy["Gyro Y axis"] = ""
gyy.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
gyy = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
gyy["Gyro Y axis"] = gyry
gyy.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)

gyz = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
gyz["Gyro Z axis"] = ""
gyz.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
gyz = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
...
max = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
max["Magnetometer X axis"] = ""
max.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
max = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
max["Magnetometer X axis"] = magx
max.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)

may = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
may["Magnetometer Y axis"] = ""
may.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
may = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
may["Magnetometer Y axis"] = magy
may.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)

maz = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
maz["Magnetometer Z axis"] = ""
maz.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
maz = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
...
term_ = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
term_["Temperature sensor"] = ""
term_.to_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv", index=False)
term_ = pd.read_csv("/home/pvl/ROS/decor_result/ROS-arbeit/Sensors/Die_Zweite/sensors_output.csv")
